...
bool S::less0() const { return pair() && cdr().more0(); }
bool S::less1() const { return pair() && cdr().more0(); }
bool S::less2() const { return pair() && cdr().more1(); }
bool S::less3() const { return pair() && cdr().more2(); }
